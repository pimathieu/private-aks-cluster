...
#Variables related to the Hub network: Network Address space, firewall subnet and bastion subnet
...
#Variables related to the AKS network: Network Address space, firewall subnet and VM/Jumpbox subnet
...
#Information related to the AKS nodes
...
variable "key_vault_name" {
  ...
  type        = string
  default     = "POCAksKeyVault10122022"
}
